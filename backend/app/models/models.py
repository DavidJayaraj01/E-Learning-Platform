...
class Course(Base):
    ...
    visibility = Column(ENUM(VisibilityType), default=VisibilityType.EVERYONE)
    access_type = Column(ENUM(AccessType), default=AccessType.OPEN)
...
class CourseEnrollment(Base):
    ...
    status = Column(ENUM(EnrollmentStatus), default=EnrollmentStatus.YET_TO_START)
